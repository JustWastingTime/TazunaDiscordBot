...
const ALL_COMMANDS = [SUPPORTER_COMMAND, SKILL_COMMAND, UMA_COMMAND, RACE_COMMAND, CM_COMMAND, LOG_COMMAND, TRAINER_COMMAND, LEADERBOARD_COMMAND, BANANA_COMMAND, PARSE_COMMAND, REGISTER_COMMAND, SETCHANNELADMIN_COMMAND, SETCHANNELLEADERBOARD_COMMAND, APPLY_COMMAND, SCHEDULE_COMMAND];
